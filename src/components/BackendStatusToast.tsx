    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-[4.5rem] left-3 right-3 sm:bottom-6 sm:left-6 sm:right-auto z-50 flex items-start gap-3 rounded-xl border border-red-500/40 bg-black/90 backdrop-blur-md px-4 py-3 shadow-2xl sm:max-w-xs"
        >
